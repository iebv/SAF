...
public class Login {
  ...
  public void testLogin() throws Exception {
    ...
    driver.findElement(By.xpath("//table[@id='260276737920940248']/tbody/tr[2]/td/a/img")).click();
    driver.findElement(By.id("ADD")).click();
    //Prueba de select list
    driver.findElement(By.cssSelector("img[alt=\"Popup Lov\"]")).click();
    driver.findElement(By.xpath("//a[contains(text(),'354487	APOLINAR CRIALES OSCAR')]")).click();
    new Select(driver.findElement(By.id("P110_FK_CENTRO_COSTO"))).selectByVisibleText("ALMACEN GENERAL");
    new Select(driver.findElement(By.id("P110_FK_CONCEPTO"))).selectByVisibleText("AD-COMBUSTIBLE");
    new Select(driver.findElement(By.id("P110_DEPARTAMENTO"))).selectByVisibleText("Bogot\\E1 D.C.");
    new Select(driver.findElement(By.id("P110_MUNICIPIO"))).selectByVisibleText("Bogot\\E1 D.C.");
  }
